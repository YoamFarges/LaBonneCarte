/**
 mapboxgl-spiderifier (https://github.com/bewithjonam/mapboxgl-spiderifier/blob/master/index.js)
 by bewithjonam (https://github.com/bewithjonam/)
    ...
    function MapboxglSpiderifier(map, userOptions) {
        ...
        function spiderfy(latLng, features) {
            ...
            spiderLegs = util.map(features, function (feature, index) {
                ...
                mapboxMarker = new mapboxgl.Marker(elements.container).setLngLat(
                    latLng
                );
        ...
        function unspiderfy() {
            util.each(previousSpiderLegs.reverse(), function (spiderLeg, index) {
                if (options.animate) {
                    spiderLeg.elements.container.style["transitionDelay"] =
                        (options.animationSpeed / 1000 / previousSpiderLegs.length) *
                        index +
                        "s";
